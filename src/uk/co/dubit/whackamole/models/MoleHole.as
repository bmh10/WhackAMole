package uk.co.dubit.whackamole.models
{
	...
	public class MoleHole extends Model
	{
		...
		public function isStandardMole() : Boolean
		{
			mole.getMoleType()
			return (mole.getMoleType()=="standardMole");
		}
		
		public function isFireMole() : Boolean
		{
			return (mole.getMoleType()=="fireMole");
		}
		
		public function isZombieMole() : Boolean
		{
			return (mole.getMoleType()=="zombieMole");
		}
		...
		public function hit() : void
		{
			if(mole && !mole.dead)
			{
				...
				if(mole.dead)
				{
					...
					//Update game stats
					mainGame.molesKilled++;
					if (mole.getMoleType()=="fireMole")
						mainGame.fireMolesKilled++;
					else if (mole.getMoleType()=="zombieMole")
						mainGame.zombieMolesKilled++;
				}
			}
		}
